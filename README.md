...
```javascript
import { clacgv, clacpy, claset, claswp, crot, dgetrans, dgttrf, disnan, dlacpy, dladiv, dlaisnan, dlamch, dlapy2, dlapy3, dlarf, dlarf1f, dlaruv, dlaset, dlassq, dlaswp, dpttrf, iladlc, iladlr, sgetrans, slacpy, slaswp, spttrf, zlacgv, zlacpy, zlaset, zlaswp, zrot } from 'https://cdn.jsdelivr.net/gh/stdlib-js/lapack-base@deno/mod.js';
```
...
[@stdlib/lapack/base/disnan]: https://github.com/stdlib-js/lapack-base-disnan/tree/deno
...
[@stdlib/lapack/base/dlaisnan]: https://github.com/stdlib-js/lapack-base-dlaisnan/tree/deno
...
[@stdlib/lapack/base/dlarf]: https://github.com/stdlib-js/lapack-base-dlarf/tree/deno

[@stdlib/lapack/base/dlarf1f]: https://github.com/stdlib-js/lapack-base-dlarf1f/tree/deno

[@stdlib/lapack/base/dlaruv]: https://github.com/stdlib-js/lapack-base-dlaruv/tree/deno
