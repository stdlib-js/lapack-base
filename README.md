...
```javascript
import { clacgv, clacpy, claset, dgetrans, dlacpy, dlamch, dlassq, dlaswp, dpttrf, sgetrans, slacpy, slaswp, spttrf, zlacgv, zlacpy, zlaset, zrot } from 'https://cdn.jsdelivr.net/gh/stdlib-js/lapack-base@esm/index.mjs';
```
