...
```javascript
import { clacgv, clacpy, claset, claswp, crot, dgetrans, dgttrf, disnan, dlacpy, dladiv, dlaisnan, dlamch, dlapy2, dlapy3, dlarf, dlarf1f, dlaset, dlassq, dlaswp, dpttrf, iladlc, iladlr, sgetrans, slacpy, slaswp, spttrf, zlacgv, zlacpy, zlaset, zlaswp, zrot } from 'https://cdn.jsdelivr.net/gh/stdlib-js/lapack-base@esm/index.mjs';
```
